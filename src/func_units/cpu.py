...
#         m.submodules.reg_file = reg_file = RegisterFile()  # Register file
...
#     cpu = CPU()
#     print(verilog.convert(cpu, ports=[cpu.inM, cpu.instruction, cpu.reset, 
#                                       cpu.outM, cpu.writeM, cpu.addressM, cpu.pc], emit_src=False))
